            ...
            <div className="lg:w-1/4">
              <div className="footer-company-infor flex flex-col justify-between gap-5">
                ...
                <div className="text caption1 text-white">
                  We are a multifaceted company dedicated to delivering tailored
                  fire safety and infrastructure solutions for both individuals
                  and enterprises.
                </div>
              ...
              <div className="company-contact">
                ...
                <div className="mt-3 flex items-center">
                  ...
                  <div className="text ml-16">
                    ...
                    <div className="fw-700 text-white mt-1">+968-96154505</div>
                  </div>
                </div>
          ...
          <div className="footer-bottom flex items-center justify-between pt-3 pb-3">
            <div className="left-block flex items-center">
              <div className="copy-right text-surface caption1">
                ©2024 Masterpieces Al Qudra Trading. All Rights Reserved.
              </div>
            </div>
