                ...
                >
                    ...
                    >
                        <div className="heading flex items-center justify-between">
                            <i className={`${data.icon} text-[#C4030A] md:text-6xl text-5xl`}></i>
                            <div className="number heading3 text-placehover">{number + 1}</div>
                        </div>
                        <div className="heading6 hover:text-[#C4030A] duration-300 mt-6">{data.title}</div>
                        <div className="text-secondary hover:bg-secondary mt-2">{data.desc}</div>
                    </Link>
                </div>
            }
            {style === 'style-two' &&
